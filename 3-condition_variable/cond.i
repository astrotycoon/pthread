...
# 2 "cond.c" 2
# 1 "/usr/lib/gcc/i686-linux-gnu/4.9/include/stdint.h" 1 3 4
# 9 "/usr/lib/gcc/i686-linux-gnu/4.9/include/stdint.h" 3 4
...
# 10 "/usr/lib/gcc/i686-linux-gnu/4.9/include/stdint.h" 2 3 4
# 3 "cond.c" 2
...
struct request {
 int value;
 struct { struct request *tqe_next; struct request * *tqe_prev; } entry;
};
...
struct __queue_request {
 ...
 struct queue_request { struct request *tqh_first; struct request * *tqh_last; } head_requests;
};
...
int main(int argc, const char *argv[])
{
 ...
 struct __queue_request request = {
   .num_request = 0U,
   .request_mutex = { { 0, 0, 0, PTHREAD_MUTEX_RECURSIVE_NP, 0, { { 0, 0 } } } },
   .got_request = { { 0, 0, 0, 0, 0, (void *) 0, 0, 0 } },
   .head_requests = { ((void *)0), &(request.head_requests).tqh_first },
 };
